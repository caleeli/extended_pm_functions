    ...
    methods: {
        ...
        onSubmit (evt) {
            ...
            if (this.validateForm()) {
                ...
                if (this.action === "Add") {
                    ProcessMaker.apiClient.post("admin/extended_pm_functions", {
                    ...
                    ProcessMaker.apiClient.patch(`admin/extended_pm_functions/${this.sample.id}`, {
                        name: this.sample.name,
                        status: this.sample.status
                    })
                        .then((response) => {
