<?php
namespace ProcessMaker\Package\Extended_pm_functions\Http\Controllers;

use ProcessMaker\Http\Controllers\Controller;
use ProcessMaker\Http\Resources\ApiCollection;
use ProcessMaker\Package\Extended_pm_functions\Models\Sample;
use RBAC;
use Illuminate\Http\Request;
use URL;


class Extended_pm_functionsController extends Controller
{
    public function index(){
        return view('extended_pm_functions::index');
    }
